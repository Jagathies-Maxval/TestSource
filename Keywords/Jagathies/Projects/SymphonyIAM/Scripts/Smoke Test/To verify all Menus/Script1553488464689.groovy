...
CustomKeywords.'package1.clickUsingJavaScript.clickJS'(findTestObject('Sanity Test/Page_4Invention Disclosures/span_Invention Disclosures'),30)
...
CustomKeywords.'package1.clickUsingJavaScript.clickJS'(findTestObject('Sanity Test/Page_1Home/span_Patents'),30)
...
WebUI.verifyTextPresent('Dashboard', false)
CustomKeywords.'package1.clickUsingJavaScript.clickJS'(findTestObject('Sanity Test/Page_8PRC Meetings/span_PRC Meetings'),30)
