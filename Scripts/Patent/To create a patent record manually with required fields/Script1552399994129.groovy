...
not_run: WebUI.verifyElementText(WebUI.getAttribute(findTestObject('NewPatent/Page_Patent Detailed View/span_Patent4'), 
        'value'), 'Patent#3 Auto')

not_run: WebUI.verifyElementText(findTestObject('NewPatent/Page_Patent Detailed View/span_Patent4'), 'Patent#3 Auto')

WebUI.verifyTextPresent('Patent#4 Auto', false)
